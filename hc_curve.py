...
# Plotting and CLI moved to hc_plotting.py / hc_cli.py.
# Keep this file as the core math/parsing library and a CLI shim.

def main_cli() -> int:
    from hc_cli import main_cli as _main_cli
    return _main_cli()
